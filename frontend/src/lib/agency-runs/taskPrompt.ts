...
- The passport's "project_facts" block describes THIS project's property (municipality, property address, parcel, square footage, uses, tenure). Use it for property/project fields only; never as the business's own address when the passport has one.
