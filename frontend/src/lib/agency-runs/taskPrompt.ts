...
- The passport's "project_facts" block describes THIS project's property (municipality, property address, parcel, square footage, uses, tenure). Fields about the establishment, premises, property or project location (e.g. "Dirección del establecimiento", "Ubicación del proyecto", catastro, square footage, use) take their values from project_facts — this is a new location of the business. The business's registered, principal or mailing address fields take the passport's own addresses. Never swap the two.
