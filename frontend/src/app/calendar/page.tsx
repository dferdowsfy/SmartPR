    ...
    <div className="min-h-screen bg-[#f4f1ea]">
      ...
      <main className="mx-auto max-w-5xl px-5 py-8">
        ...
        <section className="mt-5 overflow-hidden rounded-2xl border border-slate-200 bg-white">
          {data === null ? <div className="py-14 text-center text-slate-500">Loading calendar…</div> : events.length === 0 ? <div className="py-14 text-center"><CalendarDays className="mx-auto mb-3 h-9 w-9 text-slate-300" /><div className="font-semibold text-[#161616]">No due dates in this horizon.</div><p className="mt-1 text-sm text-slate-500">Dates stay unset until documentation or a sourced date is provided.</p></div> : <div className="divide-y divide-slate-100">{events.map((item) => {
