...
export const TEMPLATE_LIBRARY: TemplateDescriptor[] = [
  ...
  },
  {
    ...
    artifactType: "official_pdf_form",
    populationMethod: "pdf_overlay",
    submissionChannel: "not_yet_determined",
    sourceStatus: "official_source",
    ...
    requirementCode: "DOC_ALCOHOL_LICENSE",
    usageNotes: [
      ...
      "Status verified 2026-09-12: Hacienda's document repository still publishes this revision (Rev. 28 ago 14 / Rep. 26 jun 17) as the form to complete, and the 'Requisitos para cada tipo de Licencia de Rentas Internas' page directs every license type to Modelo SC 2309.",
      "Submission channel not verified — do not tell the filer where to submit. The form's notices advise confirming the filing route with Hacienda or the district office.",
      "Page 2 'Uso Oficial' and the 'Número de Solicitud' box are agency-only; the Parte IV signature line and notary block are hand-completed at signing.",
    ],
  },
  {
    formCode: "NC001",
  ...
  {
    formCode: "OGPEWS01",
    title: "OGPe Permiso Único — Use / Occupancy Prep Checklist (SmartPR)",
    ...
    submissionChannel: "agency_portal",
    sourceStatus: "smartpr_generated",
    requirementCode: "DOC_PERMISO_UNICO",
    officialSourceUrl: "https://www.ogpe.pr.gov",
    usageNotes: [
      "Permiso Único filing is 100% electronic via OGPe's Single Business Portal — there is no standalone downloadable application in RealForms.",
      "SmartPR-generated bilingual prep checklist: never present it as an official OGPe form. Prefill identity from the Business Passport; assemble Evidence locker files tagged DOC_PERMISO_UNICO and related DOC_* codes; file at ogpe.pr.gov.",
      "After issuance, upload the agency Permiso Único and tag DOC_PERMISO_UNICO.",
    ],
  },
  {
    formCode: "SALUDWS01",
    title: "Departamento de Salud — Sanitary / Food-Establishment Prep Checklist (SmartPR)",
    agency: "Departamento de Salud — Gobierno de Puerto Rico",
    scope: "statewide",
    artifactType: "smartpr_generated",
    populationMethod: "none",
    submissionChannel: "agency_portal",
    sourceStatus: "smartpr_generated",
    requirementCode: "DOC_HEALTH_PERMIT",
    officialSourceUrl: "https://www.salud.pr.gov/",
    usageNotes: [
      "Sanitary/health endorsement is commonly processed inside OGPe's Permiso Único (Secretaría Auxiliar de Salud Ambiental); no standalone Salud PDF in RealForms.",
      "SmartPR-generated bilingual prep checklist gated by existing Salud docs (DOC_HEALTH_PERMIT, and DOC_CFPM when food-manager rules apply). Never present it as an official Salud form.",
      "Tag supporting evidence in the Evidence locker; after issuance upload the Health / Sanitary Permit tagged DOC_HEALTH_PERMIT.",
    ],
  },
  {
    formCode: "BOMBEROSWS01",
    title: "Cuerpo de Bomberos — Fire-Safety Inspection Prep Checklist (SmartPR)",
    agency: "Cuerpo de Bomberos de Puerto Rico",
    scope: "statewide",
    artifactType: "smartpr_generated",
    populationMethod: "none",
    submissionChannel: "agency_portal",
    sourceStatus: "smartpr_generated",
    requirementCode: "DOC_FIRE_CERT",
    officialSourceUrl: "https://bomberos.pr.gov/permisos",
    usageNotes: [
      "Certificación de Prevención de Incendios (CPI) is processed through OGPe; a Bomberos prevention inspection underlies it. No standalone Bomberos PDF in RealForms.",
      "SmartPR-generated bilingual inspection prep checklist: never present it as an official Bomberos form. Inspection readiness is in person; tracking/filing is via agency/OGPe channels — SmartPR does not e-file.",
      "Tag supporting evidence DOC_FIRE_CERT (and related DOC_*); after approval upload the issued certification.",
    ],
  },
];
