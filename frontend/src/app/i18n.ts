...
export const ES: Record<string, string> = {
  ...
  "View": "Ver",
  "Complete DACO form": "Completa el formulario de DACO",
  "Already have the license?": "¿Ya tienes la licencia?",
  "Upload contractor license": "Sube la licencia de contratista",
  "Complete patente form": "Completa el formulario de patente",
  "Already filed?": "¿Ya la radicaste?",
  "Upload filed document": "Sube el documento radicado",
  ...
  "Complete bona fide farmer application": "Completa la solicitud de agricultor bona fide",
  "Already have your bona fide farmer certification?": "¿Ya tienes tu certificación de agricultor bona fide?",
  "Upload certification": "Sube la certificación",
  "Complete CBP bond form": "Completa el formulario de fianza de CBP",
  "Already have a customs bond?": "¿Ya tienes una fianza de aduana?",
  "Upload customs bond": "Sube la fianza de aduana",
  "Complete EPA NPDES package": "Completa el paquete NPDES de la EPA",
  "Already have the signed/filed package?": "¿Ya tienes el paquete firmado o radicado?",
  "Upload signed package": "Sube el paquete firmado",
  "EPA NPDES permit package": "Paquete del permiso NPDES de la EPA",
  "Start form": "Comenzar formulario",
  "View form": "Ver formulario",
  "Draft in progress": "Borrador en progreso",
  "Not started": "Sin comenzar",
  "Ready to print and sign": "Lista para imprimir y firmar",
  "Submitted": "Sometido",
  "Approved": "Aprobado",
  "Needs review": "Necesita revisión",
