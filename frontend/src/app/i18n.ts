...
export const ES: Record<string, string> = {
  ...
  "What is the primary use of the facility?": "¿Cuál es el uso principal de la facilidad?",
  "The facility's primary use determines which permits and agencies apply to the project.": "El uso principal de la facilidad determina qué permisos y agencias aplican al proyecto.",
  "Will the project change the property's occupancy or permitted use?": "¿El proyecto va a cambiar la ocupación o el uso permitido de la propiedad?",
  "A change of occupancy or permitted use triggers additional approvals beyond the construction work itself.": "Un cambio de ocupación o de uso permitido requiere aprobaciones adicionales además del trabajo de construcción.",
  "Does the work affect structural components?": "¿El trabajo afecta componentes estructurales?",
  "Structural work changes which construction approvals are required and who must certify the plans.": "El trabajo estructural cambia qué aprobaciones de construcción se requieren y quién debe certificar los planos.",
  "Will exterior or site work be included?": "¿Se incluirá trabajo exterior o del terreno?",
  "Exterior and site work can involve additional permits beyond the building itself.": "El trabajo exterior y del terreno puede conllevar permisos adicionales además del edificio.",
  "Warehouse": "Almacén",
  "Commercial office": "Oficina comercial",
  "Mixed use": "Uso mixto",
  "Do you lease your commercial space?": "¿Alquilas tu local comercial?",
  "Will the business lease its commercial space?": "¿El negocio va a alquilar su local comercial?",
  ...
  "Required": "Requerido",
  "Likely required": "Probablemente requerido",
  "Verify existing": "Verifica tu registro actual",
  "More information needed": "Se necesita más información",
  "Supporting evidence": "Documento de apoyo",
  "Optional": "Opcional",
  "Ready": "Listo",
  "Waiting": "En espera",
  ...
  "e.g. Guaynabo warehouse expansion": "p. ej. ampliación del almacén en Guaynabo",
  ...
  "Filing": "Radicación",
  "You can fill out and complete this form right in SmartPR.": "Puedes llenar y completar este formulario aquí mismo en SmartPR.",
  "This is filed with {agency} — SmartPR prepares your worksheet so you can file it faster.": "Esto se radica ante {agency}; SmartPR te prepara la hoja de trabajo para que radiques más rápido.",
  "SmartPR prepares your worksheet so you can file it faster.": "SmartPR te prepara la hoja de trabajo para que radiques más rápido.",
  "This is filed directly with {agency} — upload the issued document here to keep your package complete.": "Esto se radica directamente con {agency}; sube el documento emitido aquí para mantener tu paquete completo.",
  ...
  "Active": "Activo",
  "Active filing": "Radicación activa",
  "Active filings": "Radicaciones activas",
  "Added": "Añadido",
  "Agency not recorded": "Agencia no registrada",
  "All requirements": "Todos los requisitos",
  "Business details": "Detalles del negocio",
  "Add your business details": "Añade los detalles de tu negocio",
  "Add": "Añadir",
  "Enter it once — SmartPR carries it to every requirement.": "Escríbelo una vez — SmartPR lo lleva a cada requisito.",
  ...
  "Business type": "Tipo de negocio",
  "Business type not entered": "Tipo de negocio no registrado",
  "Cancel": "Cancelar",
  "Completed document:": "Documento completado:",
  "Compliance Calendar": "Calendario de cumplimiento",
  "Compliance calendar": "Calendario de cumplimiento",
  "Continue": "Continuar",
  "Continue filing": "Continuar radicación",
  "Could not save the completed document.": "No se pudo guardar el documento completado.",
  "Could not update.": "No se pudo actualizar.",
  "Could not upload.": "No se pudo subir el documento.",
  "Couldn't load this business right now.": "No se pudo cargar este negocio en este momento.",
  "Date source": "Fuente de la fecha",
  "Deliverable library": "Biblioteca de entregables",
  "Document extracted": "Documento extraído",
  "Download": "Descargar",
  ...
  "OVERDUE": "VENCIDO",
  "COMPLETED": "COMPLETADO",
  "Entity number": "Número de entidad",
  "Entity number not entered": "Número de entidad no registrado",
  "Entry created": "Registro creado",
  "Existing business reconstruction": "Reconstrucción de negocio existente",
  "Externally verified": "Verificado externamente",
  "Filing history": "Historial de radicaciones",
  "Filing matter": "Asunto de radicación",
  "Filings & Documents": "Radicaciones y documentos",
  "Hide": "Ocultar",
  "History & Notifications": "Historial y notificaciones",
  "In progress": "En progreso",
  "Legal name": "Nombre legal",
  "Loading compliance profile…": "Cargando perfil de cumplimiento…",
  "Mark filing complete": "Marcar radicación como completada",
  "Mark renewed / complete": "Marcar como renovado / completado",
  "Marked as complete": "Marcado como completado",
  "Missing information": "Falta información",
  "Missing Requirements": "Requisitos pendientes",
  "Municipality not entered": "Municipio no registrado",
  "Need attention": "Necesitan atención",
  "Needs attention": "Necesita atención",
  "Needs information": "Necesita información",
  "Next best action": "Próxima mejor acción",
  "No active filings.": "No hay radicaciones activas.",
  "No applicable requirements recorded yet.": "Aún no hay requisitos aplicables registrados.",
  "No date": "Sin fecha",
  "No date set": "Sin fecha",
  "No due date set — upload current documentation or enter the date.": "Sin fecha de vencimiento — sube la documentación actual o entra la fecha.",
  "No filing history yet.": "Aún no hay historial de radicaciones.",
  "No missing requirements are recorded.": "No hay requisitos pendientes registrados.",
  "No outstanding requirements.": "No hay requisitos pendientes.",
  "No reminders have been scheduled.": "No se han programado recordatorios.",
  "No uploaded evidence is associated with this business.": "No hay evidencia subida asociada a este negocio.",
  "Not entered": "No registrado",
  "Notes": "Notas",
  "Notifications": "Notificaciones",
  "Onboarding mode": "Modo de registro",
  "On track": "Al día",
  "Opened": "Abierto",
  "Overall readiness": "Preparación general",
  "Overdue": "Vencido",
  "Physical address": "Dirección física",
  "Regulatory rule": "Regla regulatoria",
  "Save date": "Guardar fecha",
  "Scheduled": "Programado",
  "SmartPR formation workflow": "Flujo de formación de SmartPR",
  "Start New Filing / Renewal": "Comenzar nueva radicación / renovación",
  "Try again": "Intentar de nuevo",
  "Unmatched evidence": "Evidencia sin asociar",
  "Upcoming": "Próximo",
  "Update date": "Actualizar fecha",
  "Update due date": "Actualizar fecha de vencimiento",
  "Uploading…": "Subiendo…",
  "User provided": "Proporcionado por el usuario",
  "View all requirements": "Ver todos los requisitos",
  "View full calendar": "Ver calendario completo",
  "Start renewal now": "Comenzar renovación ahora",
  "Prepare renewal filing": "Preparar radicación de renovación",
  "Review renewal requirements": "Revisar requisitos de renovación",
  "Review extracted information": "Revisar información extraída",
  "Upload current evidence": "Subir evidencia actual",
  "Enter date or upload evidence": "Entra la fecha o sube evidencia",
  "View filing record": "Ver registro de radicación",
  "No action required": "No se requiere acción",
  "New business formation": "Formación de negocio nuevo",
  "Annual report": "Informe anual",
  "Annual fee": "Cuota anual",
  "Permiso Único renewal": "Renovación de Permiso Único",
  "Health license renewal": "Renovación de licencia de salud",
  "Municipal license renewal": "Renovación de patente municipal",
  "Change of address": "Cambio de dirección",
  "Change of owner": "Cambio de dueño",
  "Second location": "Segunda localidad",
  "Permit modification": "Modificación de permiso",
  "Other regulatory filing": "Otra radicación regulatoria",
  "Could not start this filing.": "No se pudo iniciar esta radicación.",
  "New matter": "Nuevo asunto",
  "Start a filing or renewal": "Comenzar una radicación o renovación",
  "The matter stays beneath this business and opens in the same SmartPR rules and document workflow.": "El asunto queda bajo este negocio y se abre en el mismo flujo de reglas y documentos de SmartPR.",
  "Matter type": "Tipo de asunto",
  "Title": "Título",
  "(optional)": "(opcional)",
  "Known due date": "Fecha de vencimiento conocida",
  "Leave this blank if the date is not known. SmartPR will not infer one.": "Déjalo en blanco si no conoces la fecha. SmartPR no va a inferir una.",
  "Source reference": "Referencia de la fuente",
  "Starting filing…": "Iniciando radicación…",
  "Start filing": "Comenzar radicación",
  "Unknown": "Desconocido",
  "Due dates": "Fechas de vencimiento",
  "Portfolio-level deadlines linked to the relevant business and obligation.": "Vencimientos de todo tu portafolio, enlazados al negocio y requisito correspondiente.",
  "All businesses": "Todos los negocios",
  "View annual filings →": "Ver radicaciones anuales →",
  "yearly renewals like Informe Anual and Patente, in one place.": "renovaciones anuales como Informe Anual y Patente, en un solo lugar.",
  "Annual horizon": "Horizonte anual",
  "All dates": "Todas las fechas",
  "overdue": "vencidos",
  "Loading calendar…": "Cargando calendario…",
  "No due dates in this horizon.": "No hay vencimientos en este horizonte.",
  "Dates stay unset until documentation or a sourced date is provided.": "Las fechas quedan sin asignar hasta que se provea documentación o una fecha con fuente.",
  "Recurring compliance": "Cumplimiento recurrente",
  "Annual filings": "Radicaciones anuales",
  "Every yearly filing for every business — Informe Anual, Patente, CRIM — in one place. SmartPR reminds you 90, 60, 30 and 7 days out, and queues next year's filing the moment you complete this one.": "Cada radicación anual de cada negocio — Informe Anual, Patente, CRIM — en un solo lugar. SmartPR te recuerda 90, 60, 30 y 7 días antes, y programa la del próximo año en cuanto completas esta.",
  "Filter by business": "Filtrar por negocio",
  "Filed": "Radicado",
  "View full compliance calendar →": "Ver calendario de cumplimiento completo →",
  "Loading filings…": "Cargando radicaciones…",
  "No annual filings tracked yet.": "Aún no hay radicaciones anuales en seguimiento.",
  "Annual filings appear here once your businesses have obligations with a yearly renewal — for example the Informe Anual or the municipal Patente.": "Las radicaciones anuales aparecen aquí cuando tus negocios tengan obligaciones con renovación anual — por ejemplo el Informe Anual o la Patente municipal.",
  "renews every year": "se renueva cada año",
  // ---- Enterprise reminders admin (Phase 4) ----
  "Reminders & deadlines": "Recordatorios y vencimientos",
  "Reminder rules, escalation policies and deadline schedules for this organization.": "Reglas de recordatorio, políticas de escalamiento y fechas de vencimiento para esta organización.",
  "Reminder rules": "Reglas de recordatorio",
  "Escalation policies": "Políticas de escalamiento",
  "Deadline schedules": "Fechas de vencimiento",
  "Test run": "Prueba",
  "Run now": "Ejecutar ahora",
  "New rule": "Nueva regla",
  "New policy": "Nueva política",
  "New deadline": "Nuevo vencimiento",
  "No reminder rules yet.": "Aún no hay reglas de recordatorio.",
  "No escalation policies yet.": "Aún no hay políticas de escalamiento.",
  "No deadline schedules yet.": "Aún no hay fechas de vencimiento.",
  "verified deadline": "vencimiento verificado",
  "internal target": "meta interna",
  "All businesses and obligations": "Todos los negocios y requisitos",
  "Steps": "Pasos",
  "Offsets (days before due)": "Antelación (días antes del vencimiento)",
  "Channels": "Canales",
  "Inactive": "Inactiva",
  "Edit": "Editar",
  "Delete": "Eliminar",
  ...
  "Activate": "Activar",
  "Running…": "Ejecutando…",
  "An internal target is a planning date, not a verified regulatory deadline.": "Una meta interna es una fecha de planificación, no un vencimiento reglamentario verificado.",
  "Saved.": "Guardado.",
  "Loading…": "Cargando…",
  "reminders sent": "recordatorios enviados",
  "When does your current one expire?": "¿Cuándo se vence el que tienes ahora?",
  "I don't know": "No sé",
  ...
  "escalations fired": "escalamientos activados",
  "skipped (already sent)": "omitidos (ya enviados)",
  "Label": "Etiqueta",
  "Type": "Tipo",
  "Due": "Vencimiento",
  "grace": "gracia",
  ...
  "requires compliance manager approval": "requiere aprobación de un compliance manager",
  // 2026-09-18 QA (live S41): KB and hardcoded intake question headings
  // rendered in English inside Spanish filings. Every question text the
  // intake can surface now carries a Puerto Rican Spanish entry here.
  "What is the legal structure of the business?": "¿Cuál es la estructura legal del negocio?",
  "What type of location will the business use?": "¿Qué tipo de local usará el negocio?",
  "Will the business be operated from a home?": "¿Se operará el negocio desde una residencia?",
  "Will the business operate entirely online?": "¿Operará el negocio completamente en línea?",
  "Does the business own the property it will operate from?": "¿El negocio es dueño de la propiedad donde operará?",
  "Will construction or renovations be performed at the location?": "¿Se hará construcción o remodelación en el local?",
  "Will the business provide customer parking?": "¿El negocio proveerá estacionamiento para clientes?",
  "How many employees will the business have?": "¿Cuántos empleados tendrá el negocio?",
  "Will food be served to customers?": "¿Se servirá comida a los clientes?",
  "Will the business operate from a food truck or mobile unit?": "¿Operará el negocio desde un food truck o unidad móvil?",
  "Will a commercial kitchen be used?": "¿Se usará una cocina comercial?",
  "Will a Certified Food Protection Manager be on staff?": "¿Contará el negocio con un manejador de alimentos certificado?",
  "Will alcohol be manufactured or bottled?": "¿Se manufacturará o embotellará alcohol?",
  "Will healthcare services be provided?": "¿Se proveerán servicios de salud?",
  "Will patients visit the location?": "¿Visitarán pacientes el local?",
  "Will controlled substances be stored or dispensed?": "¿Se almacenarán o dispensarán sustancias controladas?",
  "How many commercial vehicles will be operated?": "¿Cuántos vehículos comerciales se operarán?",
  "Will vehicles be repaired or serviced?": "¿Se repararán vehículos o se les dará mantenimiento?",
  "Will hazardous fluids be stored or handled?": "¿Se almacenarán o manejarán fluidos peligrosos?",
  "Will used vehicles be sold?": "¿Se venderán vehículos usados?",
  "Will fuel be sold?": "¿Se venderá combustible?",
  "Will chemicals be used or stored in production?": "¿Se usarán o almacenarán químicos en la producción?",
  "Will the business offer tourism activities?": "¿Ofrecerá el negocio actividades turísticas?",
  "Will water-based activities be offered?": "¿Se ofrecerán actividades acuáticas?",
  "Will guided excursions be offered?": "¿Se ofrecerán excursiones guiadas?",
  "Will this be a short-term rental?": "¿Será un alquiler a corto plazo?",
  "How many rental units will be operated?": "¿Cuántas unidades de alquiler se operarán?",
  "Will the business have commercial signage?": "¿Tendrá el negocio letreros comerciales?",
  "What type of signage will be used?": "¿Qué tipo de letrero se usará?",
  "Will hazardous materials require dedicated storage?": "¿Los materiales peligrosos requerirán almacenamiento dedicado?",
  "Will operations have a potential environmental impact?": "¿Las operaciones tendrán un posible impacto ambiental?",
  "Will a fuel-powered generator be installed?": "¿Se instalará una planta eléctrica?",
  "Will import/export activity occur?": "¿Ocurrirá actividad de importación/exportación?",
  "Will a customs broker be used?": "¿Se usará un agente de aduana?",
  "Will professional licenses be required for staff?": "¿Se requerirán licencias profesionales para el personal?",
  "Which professional licenses apply?": "¿Qué licencias profesionales aplican?",
  "Will goods be sold directly to consumers?": "¿Se venderá mercancía directamente a los consumidores?",
  "Will inventory be stored on-site?": "¿Se almacenará inventario en el local?",
  "Will physical hardware or equipment be sold?": "¿Se venderá equipo o hardware físico?",
  "Will deliveries be made to customers?": "¿Se harán entregas a los clientes?",
  "Will goods be stored in a warehouse or facility?": "¿Se almacenará mercancía en un almacén o facilidad?",
  "Will tobacco products be sold?": "¿Se venderán productos de tabaco?",
  "Will firearms or ammunition be sold?": "¿Se venderán armas de fuego o municiones?",
  "Will children be present at the location?": "¿Habrá menores presentes en el local?",
  "Will staff require background checks?": "¿El personal requerirá verificación de antecedentes?",
  "Will customers receive personal-care services on-site?": "¿Recibirán los clientes servicios de cuidado personal en el local?",
  "Will agricultural products be produced?": "¿Se producirán productos agrícolas?",
  "Will livestock be raised?": "¿Se criará ganado?",
  "Will pesticides or agrochemicals be applied?": "¿Se aplicarán pesticidas o agroquímicos?",
  "Will the business be cash-intensive?": "¿El negocio manejará mucho efectivo?",
  "Does the business have, or will it install, renewable energy systems such as solar panels?": "¿El negocio tiene, o instalará, sistemas de energía renovable como placas solares?",
  "Will the business contract with government agencies?": "¿Contratará el negocio con agencias del gobierno?",
  "Will the organization operate as a nonprofit?": "¿Operará la organización como entidad sin fines de lucro?",
  "Will the organization solicit donations?": "¿Solicitará la organización donativos?",
  "Is this a corporation already formed outside Puerto Rico seeking authorization to do business here?": "¿Es una corporación ya formada fuera de Puerto Rico que busca autorización para hacer negocios aquí?",
  "Is this entity registering as a Limited Liability Partnership (SRL)?": "¿Esta entidad se está registrando como Sociedad de Responsabilidad Limitada (SRL)?",
  "Is the property part of a condominium, HOA, or other residential association?": "¿La propiedad es parte de un condominio, asociación de residentes u otra asociación residencial?",
  "Will the solar system be roof-mounted or ground-mounted?": "¿El sistema solar será instalado en el techo o en el suelo?",
  ...
  "Link your business (existing business → pick it above) so Clara can file for it.": "Vincula tu negocio (negocio existente → elígelo arriba) para que Clara pueda radicar por él.",
  "New location for your business in": "Nueva ubicación de tu negocio en",
  "not covered by your registered location": "no la cubre tu ubicación registrada",
  "Required for the new premises — your existing permits cover your current location only": "Requerido para el nuevo local: tus permisos actuales solo cubren tu ubicación actual",
  "Includes the use authorization": "Incluye la autorización de uso",
  "Only if it applies": "Solo si aplica",
  "Copy of the issued": "Copia del documento emitido:",
  "REQUIRED NOW": "REQUERIDO AHORA",
  "CONDITIONAL / NEEDS INFORMATION": "CONDICIONAL / FALTA INFORMACIÓN",
  "WAITING ON PREREQUISITES": "EN ESPERA DE REQUISITOS PREVIOS",
  "SUPPORTING DOCUMENTS": "DOCUMENTOS DE APOYO",
  "REGISTRATIONS / LICENSES": "REGISTROS / LICENCIAS",
  "File or obtain these for this project. Critical-path items come first.": "Radica u obtén estos para este proyecto. Primero los de ruta crítica.",
  "May apply. Each one says which fact decides it — answer it here and the path updates.": "Podrían aplicar. Cada uno dice qué dato lo decide: contéstalo aquí y la ruta se actualiza.",
  "Required, but each can be filed only after the prerequisite it names.": "Requeridos, pero cada uno se radica solo después del requisito previo que indica.",
  "Documents the filings above rely on.": "Documentos en los que se apoyan las radicaciones anteriores.",
  "Business registrations and licenses.": "Registros y licencias del negocio.",
  "Already held by your business — confirm they are current.": "Tu negocio ya los tiene: confirma que estén vigentes.",
  "Issued and on file.": "Emitidos y archivados.",
  "Environmental review": "Revisión ambiental",
  "Potential — needs more information": "Potencial — falta información",
  "Applicability depends on equipment, emissions, fuel, wastewater, or hazardous materials. No environmental permit follows from the facts given so far; SmartPR re-checks the knowledge graph once these are known.": "Depende de equipos, emisiones, combustible, aguas residuales o materiales peligrosos. Con los datos dados hasta ahora no aplica ningún permiso ambiental; SmartPR vuelve a revisar el grafo de conocimiento cuando se conozcan.",
  "Prepare with Clara": "Preparar con Clara",
  "View filing instructions": "Ver instrucciones de radicación",
  "Open agency site": "Abrir sitio de la agencia",
  "Sign in to let Clara use your saved information.": "Inicia sesión para que Clara use tu información guardada.",
  "Evidence": "Evidencia",
  "Prerequisites": "Requisitos previos",
  "On file": "Archivado",
  "Depends on your answer": "Depende de tu respuesta",
  "Issued": "Emitido",
  "Prepared — not filed": "Preparado — sin radicar",
  "Not filed": "Sin radicar",
  "Can file this": "Puede radicarlo",
  "Can prepare this": "Puede prepararlo",
  "Not supported yet": "Aún no disponible",
  "None — needed before": "Ninguno — necesario antes de",
  "None": "Ninguno",
  "Rule": "Regla",
  "Showing details from your description so you can correct them.": "Mostrando los datos de tu descripción para que puedas corregirlos.",
  "detail already known from your description": "dato ya conocido por tu descripción",
  "details already known from your description": "datos ya conocidos por tu descripción",
