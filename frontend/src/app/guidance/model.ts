...
export type GuidanceFactKey = "Q_ALCOHOL_SOLD" | "Q_ALCOHOL_SERVED" | "Q_ALCOHOL_MANUFACTURED" | "Q_PHYSICAL_LOCATION" | "Q_EMPLOYEES_HIRED" | "Q_EXISTING_LEASE" | "Q_FOOD_PREPARED" | "Q_FOOD_SOLD" | "Q_CUSTOMERS_VISIT" | "Q_RENEWABLE_INSTALL" | "Q_SOLAR_MOUNTING" | "Q_SOLAR_SIZE" | "Q_SOLAR_OWNERSHIP" | "Q_FEDERAL_CONTRACTS_GRANTS" | "Q_OFFERS_CONSTRUCTION_SERVICES" | "Q_COMMERCIAL_VEHICLES" | "Q_HAZMAT_TRANSPORT" | "Q_AGRICULTURE_PRODUCTION" | "Q_SHORT_TERM_RENTAL" | "Q_GUESTS_OVERNIGHT" | "Q_COMMERCIAL_SIGNAGE" | "Q_OUTDOOR_SEATING" | "Q_CHILDREN_PRESENT" | "Q_HOA_CONDO" | "Q_LIVE_ENTERTAINMENT" | "project_type" | "entityType" | "municipality" | "businessType";
...
export function validateGuidanceConcept(value: unknown, requirementId?: string): string[] {
  ...
  if (!Array.isArray(c.sources) || !c.sources.length || c.sources.some(s => {
    ...
    try {
      ...
      return url.protocol !== "https:" || !(url.hostname.endsWith(".gov") || url.hostname === "www.municipiodebayamon.com" || url.hostname === "www.sanjuanciudadpatria.com" || url.hostname.endsWith(".fondopr.com"));
    } catch { return true; }
